Rails.application.config.middleware.use OmniAuth::Builder do
  ...
  provider :facebook, Copper::Application.config.facebook_appid, Copper::Application.config.facebook_secret, :setup => true, :client_options => {:ssl => {:ca_file => '/usr/lib/ssl/certs/ca-certificates.crt'}}
