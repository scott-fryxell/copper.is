...
Rails.application.config.middleware.use OmniAuth::Builder do
  ...
  provider :facebook, Copper::Application.config.facebook_key, Copper::Application.config.facebook_secret, {:scope => 'email, offline_access, user_likes', :client_options => {:ssl => {:ca_file => '/usr/lib/ssl/certs/ca-certificates.crt'}}}
